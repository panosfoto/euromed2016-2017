...
<html>
    ...
    <title>Euromed 2016: Info for Speakers & Researchers</title>
    <body>
        <div id="frame">
            <div id="page">
                <a name="top"></a>
                ...
                <div class=side_menu>
                     <ul>
                      ...
                      <ul>
                        ...
                        <li class="active"><a href="info_for_speakers.php">Info for Speakers & Researchers</a></li>
                        <ul>
                          <li><a href="info_for_speakers/information.php">General Information</a></li>
                          <li><a href="info_for_speakers/paper_submission.php">Paper Submission</a></li>
                        </ul>
                      </ul>
