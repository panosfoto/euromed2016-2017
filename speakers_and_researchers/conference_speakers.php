            ...
            <div id="page">
                ...
                <div class=side_menu>
                     <ul>
                      ...
                      <ul>
                        <li class="active"><a href="conference_speakers.php">Conference Speakers</a></li>
                        <li><a href="info_for_speakers.php">Info for Speakers & Researchers</a></li>
                      </ul>
                ...
                <div class="page_content">
                    <div><h1>Conference Speakers</h1></div>
                    <div class=order_bar>
                        <button id="nameorderbutton" onClick="$(this).order_speakers();">Name &darr;</button>
                        <button id="famousorderbutton" onClick="$(this).order_speakers_famous();">Publicity</button>
