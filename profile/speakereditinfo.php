...
<html>
    ...
    <title>Euromed 2016: Speaker Edit Info</title>
    <body>
        <div id="frame">
            <div id="page">
                <a name="top"></a>
                ...
                <div id="navigation">
                    <a href="../index.php">Home</a> <font size="3" class="arrow">&#8594;</font> <a href="../profile.php">Profile </a> <font size="3" class="arrow">&#8594;</font>  <a href="speakereditinfo.php">Speaker Edit Info</a>
                </div>
                    ...
                    <?php include("uptxt.php");?>
                        <form action="" method="POST" enctype="multipart/form-data"/>
                            ...
                            <div style="width:100%;height:auto;">
                                <textarea name="short_info" cols="40" rows="5" style="width:50%;height:25%;float:left;"placeholder="Short info..."value=""></textarea>
                                <input class="field" type="text" name="site" value="" placeholder="Personal site (url)" size="23"/>
                            </div>
                            <div style="float:left;width:100%;">Upload an image of you!</div>
                            <div style="width:100%;margin-top:30%;text-align:middle;">
