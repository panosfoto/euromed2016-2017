...
<html>
    ...
    <title>Euromed 2016: Downloads</title>
    <body>
        <div id="frame">
            <div id="page">
                <a name="top"></a>
                ...
                <div id="navigation">
                    <a href="index.php">Home</a> <font size="3" class="arrow">&#8594;</font> <a href="downloads.php">Downloads</a>
                </div>
                ...
                <div class="page_content">
                    ...
                    <!---<p> &#11044; Video: "Students getting raped by anti-sos" (link censored)</p>--->
                </div>
                <div class="ads_panel">
                        <a href="index.php">
