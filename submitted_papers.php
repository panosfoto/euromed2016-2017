    ...
    <body>
        <div id="frame">
            <div id="page">
                ...
                <div id="navigation">
                    <a href="index.php">Home</a> <font size="3" class="arrow">&#8594;</font> <a href="submitted_papers.php">Submitted Papers</a>
                </div>
                ...
                <div class=side_menu>
                     <ul>
                      ...
                      <li class="active"><a href="submitted_papers.php">Submitted Papers</a></li>
