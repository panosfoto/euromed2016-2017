...
<!-- </form> -->
    ...
    <table  width="100%">
        <thead>
            <tr>
            <th></th>
            <th class="reg-not-available"><s>Early Registration</s> CLOSED <br>Until 24 Oct. 2016</th><th>Late Registration<br>25 Oct. 2016</th>			<th>Persons</th>
            </tr>
        </thead>
        <tbody>
            <tr><td>Students</td><td><label><s>€&nbsp;360</s></label></td><td><label>€&nbsp;450</label></td><td><select style="width:70px;" name="students-entire" id="students-entire" class="form-control persons_registration" required><option value="">0</option><option value="2[450[1">1</option><option value="2[450[2">2</option><option value="2[450[3">3</option><option value="2[450[4">4</option><option value="2[450[5">5</option><option value="2[450[6">6</option><option value="2[450[7">7</option><option value="2[450[8">8</option><option value="2[450[9">9</option><option value="2[450[10">10</option></select></td></tr><tr><td>Non students</td><td><label><s>€&nbsp;440</s></label></td><td><label>€&nbsp;500</label></td><td><select style="width:70px;" name="non students-entire" id="non-entire" class="form-control persons_registration" required><option value="">0</option><option value="4[500[1">1</option><option value="4[500[2">2</option><option value="4[500[3">3</option><option value="4[500[4">4</option><option value="4[500[5">5</option><option value="4[500[6">6</option><option value="4[500[7">7</option><option value="4[500[8">8</option><option value="4[500[9">9</option><option value="4[500[10">10</option></select></td></tr>		</tbody>
...
<div class=" name_persons" >
    ...
    <table  width="100%">
        ...
        <tbody>
            <tr><td>Students</td><td><label><s>€&nbsp;125</s></label></td><td><label>€&nbsp;155</label></td><td><select style="width:70px;" name="students-daily" id="students-daily" class="form-control persons_registration" required><option value="">0</option><option value="6[155[1">1</option><option value="6[155[2">2</option><option value="6[155[3">3</option><option value="6[155[4">4</option><option value="6[155[5">5</option><option value="6[155[6">6</option><option value="6[155[7">7</option><option value="6[155[8">8</option><option value="6[155[9">9</option><option value="6[155[10">10</option></select></td></tr><tr><td>Non students</td><td><label><s>€&nbsp;180</s></label></td><td><label>€&nbsp;190</label></td><td><select style="width:70px;" name="non students-daily" id="non-daily" class="form-control persons_registration" required><option value="">0</option><option value="8[190[1">1</option><option value="8[190[2">2</option><option value="8[190[3">3</option><option value="8[190[4">4</option><option value="8[190[5">5</option><option value="8[190[6">6</option><option value="8[190[7">7</option><option value="8[190[8">8</option><option value="8[190[9">9</option><option value="8[190[10">10</option></select></td></tr>		</tbody>
...
<div class="myform_options">
    ...
    <div class="table_options">
        ...
        <tr><td><input id="Conference Bag" type="checkbox" name="options[]" value="15[70"></td><td><label for="Conference Bag">Conference Bag</label></td><td style="padding-left:10px;"></td><td>€&nbsp;70</td><td>Quantity: <select class="options-quantity" id="options-15" name="15" style="width:60px;"><option>1</option><option>2</option><option>3</option><option>4</option><option>5</option></select></td></tr><tr><td><input id="Excursion" type="checkbox" name="options[]" value="18[35"></td><td><label for="Excursion">Excursion</label></td><td style="padding-left:10px;"></td><td>€&nbsp;35</td><td>Quantity: <select class="options-quantity" id="options-18" name="18" style="width:60px;"><option>1</option><option>2</option><option>3</option><option>4</option><option>5</option></select></td></tr><tr><td><input id="Lunch with 2 coffee breaks" type="checkbox" name="options[]" value="19[40"></td><td><label for="Lunch with 2 coffee breaks">Lunch with 2 coffee breaks</label></td><td style="padding-left:10px;">for Accompanied persons</td><td>€&nbsp;40</td><td>Quantity: <select class="options-quantity" id="options-19" name="19" style="width:60px;"><option>1</option><option>2</option><option>3</option><option>4</option><option>5</option></select></td></tr><tr><td><input id="Social Dinner" type="checkbox" name="options[]" value="20[40"></td><td><label for="Social Dinner">Social Dinner</label></td><td style="padding-left:10px;">for Accompanied persons</td><td>€&nbsp;40</td><td>Quantity: <select class="options-quantity" id="options-20" name="20" style="width:60px;"><option>1</option><option>2</option><option>3</option><option>4</option><option>5</option></select></td></tr>
        </table>
    </div>
</div>
